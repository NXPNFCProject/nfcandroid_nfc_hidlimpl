...
void rw_i93_get_product_version(uint8_t *p_uid) {
  ...
  DLOG_IF(INFO, nfc_debug_enabled)
      << StringPrintf("rw_i93_get_product_version ()");
...
bool rw_i93_process_sys_info(uint8_t *p_data) {
  ...
  DLOG_IF(INFO, nfc_debug_enabled)
      << StringPrintf("rw_i93_process_sys_info ()");
...
bool rw_i93_check_sys_info_prot_ext(uint8_t error_code) {
  ...
  DLOG_IF(INFO, nfc_debug_enabled)
      << StringPrintf("rw_i93_check_sys_info_prot_ext ()");
...
bool rw_i93_send_to_lower(NFC_HDR *p_msg) {
  ...
  if (NFC_SendData(NFC_RF_CONN_ID, p_msg) != NFC_STATUS_OK) {
    LOG(ERROR) << StringPrintf(
        "rw_i93_send_to_lower (): NFC_SendData () failed");
    return false;
  }
...
tNFC_STATUS rw_i93_send_cmd_inventory(uint8_t *p_uid, bool including_afi,
  ...
  DLOG_IF(INFO, nfc_debug_enabled) << StringPrintf(
      "rw_i93_send_cmd_inventory () including_afi:%d, AFI:0x%02X",
      including_afi, afi);
  ...
  if (!p_cmd) {
    LOG(ERROR) << StringPrintf(
        "rw_i93_send_cmd_inventory (): Cannot allocate buffer");
...
tNFC_STATUS rw_i93_send_cmd_stay_quiet(void) {
  ...
  DLOG_IF(INFO, nfc_debug_enabled)
      << StringPrintf("rw_i93_send_cmd_stay_quiet ()");

  p_cmd = (NFC_HDR *)GKI_getpoolbuf(NFC_RW_POOL_ID);

  if (!p_cmd) {
    LOG(ERROR) << StringPrintf(
        "rw_i93_send_cmd_stay_quiet (): Cannot allocate buffer");
    return NFC_STATUS_NO_BUFFERS;
  }
  ...
  if (rw_i93_send_to_lower(p_cmd)) {
    ...
    nfc_start_quick_timer(&rw_cb.tcb.i93.timer, NFC_TTYPE_RW_I93_RESPONSE,
                          (RW_I93_TOUT_STAY_QUIET * QUICK_TIMER_TICKS_PER_SEC) /
                              1000);
    return NFC_STATUS_OK;
  } else {
    return NFC_STATUS_FAILED;
...
tNFC_STATUS rw_i93_send_cmd_read_single_block(uint16_t block_number,
  ...
  DLOG_IF(INFO, nfc_debug_enabled)
      << StringPrintf("rw_i93_send_cmd_read_single_block ()");
...
tNFC_STATUS rw_i93_send_cmd_write_single_block(uint16_t block_number,
  ...
  DLOG_IF(INFO, nfc_debug_enabled)
      << StringPrintf("rw_i93_send_cmd_write_single_block ()");
...
tNFC_STATUS rw_i93_send_cmd_lock_block(uint8_t block_number) {
  ...
  DLOG_IF(INFO, nfc_debug_enabled)
      << StringPrintf("rw_i93_send_cmd_lock_block ()");

  p_cmd = (NFC_HDR *)GKI_getpoolbuf(NFC_RW_POOL_ID);

  if (!p_cmd) {
    LOG(ERROR) << StringPrintf(
        "rw_i93_send_cmd_lock_block (): Cannot allocate buffer");
    return NFC_STATUS_NO_BUFFERS;
  }
...
tNFC_STATUS rw_i93_send_cmd_read_multi_blocks(uint16_t first_block_number,
  ...
  DLOG_IF(INFO, nfc_debug_enabled)
      << StringPrintf("rw_i93_send_cmd_read_multi_blocks ()");
  ...
  if (rw_cb.tcb.i93.intl_flags & RW_I93_FLAG_EXT_COMMANDS) {
    UINT16_TO_STREAM(p, number_blocks -
                            1); /* Number of blocks, 0x00 to read one block */
    p_cmd->len++;
  } else {
    UINT8_TO_STREAM(p, number_blocks -
                           1); /* Number of blocks, 0x00 to read one block */
  }
...
tNFC_STATUS rw_i93_send_cmd_write_multi_blocks(uint16_t first_block_number,
  ...
  DLOG_IF(INFO, nfc_debug_enabled)
      << StringPrintf("rw_i93_send_cmd_write_multi_blocks ()");
...
tNFC_STATUS rw_i93_send_cmd_select(uint8_t *p_uid) {
  ...
  if (!p_cmd) {
    LOG(ERROR) << StringPrintf(
        "rw_i93_send_cmd_select (): Cannot allocate buffer");
    return NFC_STATUS_NO_BUFFERS;
  }
...
tNFC_STATUS rw_i93_send_cmd_reset_to_ready(void) {
  ...
  DLOG_IF(INFO, nfc_debug_enabled)
      << StringPrintf("rw_i93_send_cmd_reset_to_ready ()");
...
tNFC_STATUS rw_i93_send_cmd_write_afi(uint8_t afi) {
  ...
  DLOG_IF(INFO, nfc_debug_enabled)
      << StringPrintf("rw_i93_send_cmd_write_afi ()");

  p_cmd = (NFC_HDR *)GKI_getpoolbuf(NFC_RW_POOL_ID);

  if (!p_cmd) {
    LOG(ERROR) << StringPrintf(
        "rw_i93_send_cmd_write_afi (): Cannot allocate buffer");
    return NFC_STATUS_NO_BUFFERS;
  }
...
tNFC_STATUS rw_i93_send_cmd_lock_afi(void) {
  ...
  DLOG_IF(INFO, nfc_debug_enabled)
      << StringPrintf("rw_i93_send_cmd_lock_afi ()");

  p_cmd = (NFC_HDR *)GKI_getpoolbuf(NFC_RW_POOL_ID);

  if (!p_cmd) {
    LOG(ERROR) << StringPrintf(
        "rw_i93_send_cmd_lock_afi (): Cannot allocate buffer");
    return NFC_STATUS_NO_BUFFERS;
  }
...
tNFC_STATUS rw_i93_send_cmd_write_dsfid(uint8_t dsfid) {
  ...
  DLOG_IF(INFO, nfc_debug_enabled)
      << StringPrintf("rw_i93_send_cmd_write_dsfid ()");

  p_cmd = (NFC_HDR *)GKI_getpoolbuf(NFC_RW_POOL_ID);

  if (!p_cmd) {
    LOG(ERROR) << StringPrintf(
        "rw_i93_send_cmd_write_dsfid (): Cannot allocate buffer");
    return NFC_STATUS_NO_BUFFERS;
  }
...
tNFC_STATUS rw_i93_send_cmd_lock_dsfid(void) {
  ...
  DLOG_IF(INFO, nfc_debug_enabled)
      << StringPrintf("rw_i93_send_cmd_lock_dsfid ()");

  p_cmd = (NFC_HDR *)GKI_getpoolbuf(NFC_RW_POOL_ID);

  if (!p_cmd) {
    LOG(ERROR) << StringPrintf(
        "rw_i93_send_cmd_lock_dsfid (): Cannot allocate buffer");
    return NFC_STATUS_NO_BUFFERS;
  }
...
tNFC_STATUS rw_i93_send_cmd_get_sys_info(uint8_t *p_uid, uint8_t extra_flags) {
  ...
  DLOG_IF(INFO, nfc_debug_enabled)
      << StringPrintf("rw_i93_send_cmd_get_sys_info ()");

  p_cmd = (NFC_HDR *)GKI_getpoolbuf(NFC_RW_POOL_ID);

  if (!p_cmd) {
    LOG(ERROR) << StringPrintf(
        "rw_i93_send_cmd_get_sys_info (): Cannot allocate buffer");
    return NFC_STATUS_NO_BUFFERS;
  }
...
tNFC_STATUS rw_i93_send_cmd_get_multi_block_sec(uint16_t first_block_number,
  ...
  DLOG_IF(INFO, nfc_debug_enabled)
      << StringPrintf("rw_i93_send_cmd_get_multi_block_sec ()");
...
tNFC_STATUS rw_i93_get_next_block_sec(void) {
  ...
  DLOG_IF(INFO, nfc_debug_enabled)
      << StringPrintf("rw_i93_get_next_block_sec ()");
...
void rw_i93_sm_detect_ndef(NFC_HDR *p_resp) {
  ...
  DLOG_IF(INFO, nfc_debug_enabled) << StringPrintf(
      "rw_i93_sm_detect_ndef () sub_state:%s (0x%x)",
  ...
  case RW_I93_SUBSTATE_CHECK_LOCK_STATUS:
    ...
    DLOG_IF(INFO, nfc_debug_enabled) << StringPrintf(
        "NDEF cur_size(%d),max_size (%d), flags (0x%x)", rw_data.ndef.cur_size,
        rw_data.ndef.max_size, rw_data.ndef.flags);
...
void rw_i93_sm_read_ndef(NFC_HDR *p_resp) {
  ...
  if (NULL == p_resp) {
    DLOG_IF(INFO, nfc_debug_enabled)
        << StringPrintf("rw_i93_sm_read_ndef: p_resp is NULL");
    return;
  }
#if (NXP_EXTNS == TRUE)
...
void rw_i93_sm_update_ndef(NFC_HDR *p_resp) {
  ...
  DLOG_IF(INFO, nfc_debug_enabled) << StringPrintf(
      "rw_i93_sm_update_ndef () sub_state:%s (0x%x)",
      rw_i93_get_sub_state_name(p_i93->sub_state).c_str(), p_i93->sub_state);
...
void rw_i93_sm_format(NFC_HDR *p_resp) {
  ...
  DLOG_IF(INFO, nfc_debug_enabled) << StringPrintf(
      "rw_i93_sm_format () sub_state:%s (0x%x)",
      rw_i93_get_sub_state_name(p_i93->sub_state).c_str(), p_i93->sub_state);
...
void rw_i93_sm_set_read_only(NFC_HDR *p_resp) {
  ...
  DLOG_IF(INFO, nfc_debug_enabled) << StringPrintf(
      "rw_i93_sm_set_read_only () sub_state:%s (0x%x)",
      rw_i93_get_sub_state_name(p_i93->sub_state).c_str(), p_i93->sub_state);
...
void rw_i93_handle_error(tNFC_STATUS status) {
  ...
  DLOG_IF(INFO, nfc_debug_enabled)
      << StringPrintf("rw_i93_handle_error (): status:0x%02X, state:0x%X",
                      status, p_i93->state);
...
void rw_i93_process_timeout(TIMER_LIST_ENT *p_tle) {
  ...
  DLOG_IF(INFO, nfc_debug_enabled)
      << StringPrintf("rw_i93_process_timeout () event=%d", p_tle->event);
  ...
  if (p_tle->event == NFC_TTYPE_RW_I93_RESPONSE) {
    ...
    LOG(ERROR) << StringPrintf("rw_i93_process_timeout () unknown event=%d",
                               p_tle->event);
  }
}
...
static void rw_i93_data_cback(__attribute__((unused)) uint8_t conn_id,
  ...
  DLOG_IF(INFO, nfc_debug_enabled) << StringPrintf(
      "rw_i93_data_cback () event = 0x%X 0x%X", event, p_data->status);
  ...
  default:
    LOG(ERROR) << StringPrintf("rw_i93_data_cback (): invalid state=%d",
                               p_i93->state);
    GKI_freebuf(p_resp);
    break;
  }
...
tNFC_STATUS RW_I93Inventory(bool including_afi, uint8_t afi, uint8_t *p_uid) {
  ...
  DLOG_IF(INFO, nfc_debug_enabled) << StringPrintf(
      "RW_I93Inventory (), including_afi:%d, AFI:0x%02X", including_afi, afi);
...
tNFC_STATUS RW_I93ReadSingleBlock(uint16_t block_number) {
  ...
  DLOG_IF(INFO, nfc_debug_enabled) << StringPrintf(
      "RW_I93ReadSingleBlock () block_number:0x%02X", block_number);
...
tNFC_STATUS RW_I93WriteSingleBlock(uint16_t block_number, uint8_t *p_data) {
  ...
  if (rw_cb.tcb.i93.block_size == 0) {
    LOG(ERROR) << StringPrintf(
        "RW_I93WriteSingleBlock ():Block size is unknown");
    return NFC_STATUS_FAILED;
  }
...
tNFC_STATUS RW_I93ReadMultipleBlocks(uint16_t first_block_number,
  ...
  DLOG_IF(INFO, nfc_debug_enabled)
      << StringPrintf("RW_I93ReadMultipleBlocks ()");
...
tNFC_STATUS RW_I93WriteMultipleBlocks(uint16_t first_block_number,
  ...
  DLOG_IF(INFO, nfc_debug_enabled)
      << StringPrintf("RW_I93WriteMultipleBlocks ()");
...
tNFC_STATUS RW_I93Select(uint8_t *p_uid) {
  ...
  if (rw_cb.tcb.i93.state != RW_I93_STATE_IDLE) {
    LOG(ERROR) << StringPrintf(
        "RW_I93Select ():Unable to start command at state (0x%X)",
        rw_cb.tcb.i93.state);
    return NFC_STATUS_BUSY;
  }
...
tNFC_STATUS RW_I93WriteAFI(uint8_t afi) {
  ...
  if (rw_cb.tcb.i93.state != RW_I93_STATE_IDLE) {
    LOG(ERROR) << StringPrintf(
        "RW_I93WriteAFI ():Unable to start command at state (0x%X)",
        rw_cb.tcb.i93.state);
    return NFC_STATUS_BUSY;
  }
...
tNFC_STATUS RW_I93LockAFI(void) {
  ...
  if (rw_cb.tcb.i93.state != RW_I93_STATE_IDLE) {
    LOG(ERROR) << StringPrintf(
        "RW_I93LockAFI ():Unable to start command at state (0x%X)",
        rw_cb.tcb.i93.state);
    return NFC_STATUS_BUSY;
  }
...
tNFC_STATUS RW_I93GetMultiBlockSecurityStatus(uint16_t first_block_number,
  ...
  DLOG_IF(INFO, nfc_debug_enabled)
      << StringPrintf("RW_I93GetMultiBlockSecurityStatus ()");
...
tNFC_STATUS RW_I93ReadNDef(void) {
  ...
  if (rw_cb.tcb.i93.state != RW_I93_STATE_IDLE) {
    LOG(ERROR) << StringPrintf(
        "RW_I93ReadNDef ():Unable to start command at state (0x%X)",
        rw_cb.tcb.i93.state);
    return NFC_STATUS_FAILED;
  }
...
tNFC_STATUS RW_I93UpdateNDef(uint16_t length, uint8_t *p_data) {
  ...
  DLOG_IF(INFO, nfc_debug_enabled)
      << StringPrintf("RW_I93UpdateNDef () length:%d", length);
...
tNFC_STATUS RW_I93SetTagReadOnly(void) {
  ...
  if (rw_cb.tcb.i93.tlv_type == I93_ICODE_TLV_TYPE_NDEF) {
    if (rw_cb.tcb.i93.intl_flags & RW_I93_FLAG_READ_ONLY) {
      LOG(ERROR) << StringPrintf(
          "RW_I93SetTagReadOnly ():NDEF is already read-only");
      return NFC_STATUS_FAILED;
    }
