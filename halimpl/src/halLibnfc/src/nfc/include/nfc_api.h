...
typedef struct {
  tNFC_STATUS status; /* The event status.*/
  uint8_t nfcee_id;   /* NFCEE ID         */
  tNCI_NFCEE_PL_CONFIG
      pl_control; /* Power/Link Control Config of the original command */
...
**                     NFCEE_PL_CONFIG_P_ALWAYS_ON     NFCEE power supply is
*always on
**                     NFCEE_PL_CONFIG_L_ON_WHEN_P_ON  communication link is
*always active
**                                                          when NFCEE is
*powered on
**                     NFCEE_PL_CONFIG_PL_ALWAYS_ON    power supply and
