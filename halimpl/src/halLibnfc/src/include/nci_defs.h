...
#define NCI_PARAM_SIZE_DISCOVER_NFCEE(X)                                       \
  (((X) == NCI_VERSION_2_0) ? 0X00 : 0X01) /* Discovery Action (1 octet) */
...
#define NCI_CORE_PARAM_SIZE_NFCEE_PL_CTRL                                      \
  0x02 /* NFCEE ID (1 octet) PL config (1 octet) */
...
#define NCI_LISTEN_DH_NFCEE_ENABLE_MASK                                        \
  0x00 /* The DH-NFCEE listen is considered as a enable NFCEE */
#define NCI_LISTEN_DH_NFCEE_DISABLE_MASK                                       \
  0x02 /* The DH-NFCEE listen is considered as a disable NFCEE */
#define NCI_POLLING_DH_DISABLE_MASK                                            \
  0x00 /* The DH polling is considered as a disable NFCEE */
#define NCI_POLLING_DH_ENABLE_MASK                                             \
  0x01 /* The DH polling is considered as a enable NFCEE */
