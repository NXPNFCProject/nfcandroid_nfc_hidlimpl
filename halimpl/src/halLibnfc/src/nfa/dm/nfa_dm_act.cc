...
void nfa_dm_proc_nfcc_power_mode(uint8_t nfcc_power_mode) {
  DLOG_IF(INFO, nfc_debug_enabled) << StringPrintf(
      "nfa_dm_proc_nfcc_power_mode (): nfcc_power_mode=%d", nfcc_power_mode);
...
static void nfa_dm_nfc_response_cback(tNFC_RESPONSE_EVT event,
  ...
  case NFC_NFCC_TIMEOUT_REVT:
    ...
    } else if (nfcFL.nfcNxpEse && nfcFL.eseFL._ESE_ETSI_READER_ENABLE) {
...
bool nfa_dm_set_power_sub_state(tNFA_DM_MSG *p_data) {
  ...
  DLOG_IF(INFO, nfc_debug_enabled)
      << StringPrintf(" nfa_dm_set_power_sub_state ()");
...
void nfa_dm_rel_excl_rf_control_and_notify(void) {
  ...
  DLOG_IF(INFO, nfc_debug_enabled)
      << StringPrintf("nfa_dm_rel_excl_rf_control_and_notify ()");
...
bool nfa_dm_act_request_excl_rf_ctrl(tNFA_DM_MSG *p_data) {
  ...
  DLOG_IF(INFO, nfc_debug_enabled)
      << StringPrintf("nfa_dm_act_request_excl_rf_ctrl ()");
...
bool nfa_dm_act_release_excl_rf_ctrl(__attribute__((unused))
                                     tNFA_DM_MSG *p_data) {
  DLOG_IF(INFO, nfc_debug_enabled)
      << StringPrintf("nfa_dm_act_release_excl_rf_ctrl ()");
...
bool nfa_dm_act_deactivate(tNFA_DM_MSG *p_data) {
  ...
  LOG(ERROR) << StringPrintf(
      "nfa_dm_act_deactivate (): invalid protocol, mode or state");
...
bool nfa_dm_act_power_off_sleep(tNFA_DM_MSG *p_data) {
  DLOG_IF(INFO, nfc_debug_enabled)
      << StringPrintf("nfa_dm_act_power_off_sleep ()");
...
bool nfa_dm_act_enable_polling(tNFA_DM_MSG *p_data) {
  ...
  DLOG_IF(INFO, nfc_debug_enabled)
      << StringPrintf("nfa_dm_act_enable_polling ()");
...
static bool nfa_dm_deactivate_polling(void) {
  DLOG_IF(INFO, nfc_debug_enabled)
      << StringPrintf("nfa_dm_deactivate_polling ()");
...
bool nfa_dm_act_disable_polling(__attribute__((unused)) tNFA_DM_MSG *p_data) {
  ...
  DLOG_IF(INFO, nfc_debug_enabled)
      << StringPrintf("nfa_dm_act_disable_polling ()");
...
bool nfa_dm_act_enable_listening(__attribute__((unused)) tNFA_DM_MSG *p_data) {
  ...
  DLOG_IF(INFO, nfc_debug_enabled)
      << StringPrintf("nfa_dm_act_enable_listening ()");
...
bool nfa_dm_act_disable_listening(__attribute__((unused)) tNFA_DM_MSG *p_data) {
  ...
  DLOG_IF(INFO, nfc_debug_enabled)
      << StringPrintf("nfa_dm_act_disable_listening ()");
...
**
*******************************************************************************/
bool nfa_dm_act_disable_passive_listening(__attribute__((unused))
                                          tNFA_DM_MSG *p_data) {
  if (!nfcFL.eseFL._NFCC_ESE_UICC_CONCURRENT_ACCESS_PROTECTION) {
    DLOG_IF(INFO, nfc_debug_enabled)
        << StringPrintf("NFCC_ESE_UICC_CONCURRENT_ACCESS_PROTECTION feature is "
                        "not available!!");
    return false;
  }
  tNFA_CONN_EVT_DATA evt_data;
  ...
  DLOG_IF(INFO, nfc_debug_enabled)
      << StringPrintf("nfa_dm_act_disable_passive_listening ()");
...
bool nfa_dm_set_transit_config(tNFA_DM_MSG *p_data) {
  ...
  inpOutData.inp.data.transitConfig.val = p_data->transit_config.transitConfig;
...
bool nfa_dm_set_p2p_listen_tech(tNFA_DM_MSG *p_data) {
  DLOG_IF(INFO, nfc_debug_enabled)
      << StringPrintf("nfa_dm_set_p2p_listen_tech ()  tech_mask = %d",
...
bool nfa_dm_act_start_rf_discovery(__attribute__((unused))
  ...
  DLOG_IF(INFO, nfc_debug_enabled)
      << StringPrintf("nfa_dm_act_start_rf_discovery ()");
...
bool nfa_dm_act_stop_rf_discovery(__attribute__((unused)) tNFA_DM_MSG *p_data) {
  ...
  DLOG_IF(INFO, nfc_debug_enabled)
      << StringPrintf("nfa_dm_act_stop_rf_discovery ()");
...
bool nfa_dm_act_update_rf_params(tNFA_DM_MSG *p_data) {
  ...
  DLOG_IF(INFO, nfc_debug_enabled)
      << StringPrintf("nfa_dm_act_update_rf_params ()");
...
void nfa_dm_act_conn_cback_notify(uint8_t event, tNFA_CONN_EVT_DATA *p_data) {
  DLOG_IF(INFO, nfc_debug_enabled)
      << StringPrintf("nfa_dm_act_conn_cback_notify (): event:0x%X", event);
...
static void nfa_dm_act_data_cback(__attribute__((unused)) uint8_t conn_id,
  ...
  DLOG_IF(INFO, nfc_debug_enabled)
      << StringPrintf("nfa_dm_act_data_cback (): event = 0x%X", event);
...
static void nfa_dm_excl_disc_cback(tNFA_DM_RF_DISC_EVT event,
  ...
  DLOG_IF(INFO, nfc_debug_enabled)
      << StringPrintf("nfa_dm_excl_disc_cback (): event:0x%02X", event);
...
static void nfa_dm_poll_disc_cback(tNFA_DM_RF_DISC_EVT event,
  ...
  DLOG_IF(INFO, nfc_debug_enabled)
      << StringPrintf("nfa_dm_poll_disc_cback (): event:0x%02X", event);
...
void nfa_dm_notify_activation_status(tNFA_STATUS status,
  ...
  DLOG_IF(INFO, nfc_debug_enabled) << StringPrintf(
      "nfa_dm_notify_activation_status (): status:0x%X", status);
