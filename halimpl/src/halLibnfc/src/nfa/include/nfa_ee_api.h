...
#endif
  NFA_EE_ADD_APDU_EVT,   /* The status for adding an APDU pattern to a routing
                            table entry*/
  NFA_EE_REMOVE_APDU_EVT /* The status for removing an APDU pattern from a
                            routing table */
};
...
**
*******************************************************************************/
extern tNFA_STATUS NFA_SendPowerLinkCommand(uint8_t nfcee_id,
                                            uint8_t cfg_value);
/*******************************************************************************
**
...
**
** Description      This function is called to remove the given APDU pattern
*entry from
**                  the listen mode routing table. If the entry configures VS,
**                  it is also removed. The status of this operation is reported
...
**
*******************************************************************************/
extern tNFA_STATUS NFA_EeRemoveApduPatternRouting(uint8_t apdu_len,
                                                  uint8_t *p_apdu);
