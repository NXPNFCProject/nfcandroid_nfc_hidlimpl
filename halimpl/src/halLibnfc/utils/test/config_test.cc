...
const char SIMPLE_CONFIG[] = "# Simple config file test\n\
...
const char INVALID_CONFIG2[] = "# This is an invalid config\n\
# Byte arrays must contain at least one value\n\
TEST={}";

const char INVALID_CONFIG3[] = "# This is an invalid config\n\
# String values cannot be empty\n\
TEST=\"\"";

const char INVALID_CONFIG4[] = "# This is an invalid config\n\
# Multiple config entries with the same key\n\
TEST=1\n\
TEST=2";

const char INVALID_CONFIG5[] = "# This is an invalid config\n\
