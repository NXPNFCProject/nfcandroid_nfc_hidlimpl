...
public:
  ...
  timer_t mRecoveryTimerId = 0;         /* Timer ID for recovery timer */
...
private:
  ...
  static std::unique_ptr<Mpos> instance; /* Singleton instance of Mpos */
  ...
  friend struct std::default_delete<Mpos>;
};
#endif // MPOS_H
