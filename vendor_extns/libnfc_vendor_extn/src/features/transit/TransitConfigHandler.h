...
public:
   ...
   * @return true/false
   */
  bool updateVendorConfig(std::vector<uint8_t> configPkt);
   ...
   * @return true/false
   */
  bool storeVendorConfig(std::vector<uint8_t> configPkt);

  static std::unique_ptr<TransitConfigHandler> instance;
