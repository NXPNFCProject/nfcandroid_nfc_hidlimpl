...
public:
   ...
   */
  NFCSTATUS processCoreGenericErrorNtf(std::vector<uint8_t> &coreGenericErrorNtf);
   ...
   * NFCSTATUS_EXTN_FEATURE_FAILURE.
   */
  NFCSTATUS processCoreResetNtfReceived(std::vector<uint8_t> coreResetNtf);
   ...
   */
  std::vector<uint8_t> getDefaultRFDiscMapCmd();
