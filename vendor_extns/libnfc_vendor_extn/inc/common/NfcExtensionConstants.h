...
/**
 * @brief returns SUPPORTED_FEATURE code to framework, if HAL
 *        supports the vendor specific message
 *
 */
constexpr uint8_t SUPPORTED_FEATURE = 0;
...
constexpr uint8_t DEFAULT_NXP_SYS_CLK_FREQ_SEL_VALUE = 2; /*CLK_FREQ_19_2MHZ*/
constexpr uint8_t DEFAULT_NXP_SYS_CLK_SRC_SEL = 2;
 ...
 *
 */
enum class NfcCorePropRfMgmtSysGenInfoValues : uint8_t {
  /**
 ...
 *
 */
enum class NfcCorePropRFMgmtSysGenInfoTags : uint8_t {
  /**
 ...
 *
 */
enum class NfcHalState : uint8_t {
  /**
 ...
 *
 */
enum class RfDeactivateType : uint8_t { IDLE, SLEEP, SLEEP_AF, DISCOVER };
/** @}*/
