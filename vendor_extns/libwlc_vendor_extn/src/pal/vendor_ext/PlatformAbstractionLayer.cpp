...
WLCSTATUS PlatformAbstractionLayer::palenQueueWrite(const uint8_t *pBuffer,
                                                    uint16_t wLength) {
...
WLCSTATUS PlatformAbstractionLayer::palenQueueRspNtf(const uint8_t *pBuffer,
                                                     uint16_t wLength) {
...
void PlatformAbstractionLayer::palSendWlcDataCallback(uint16_t dataLen,
                                                      const uint8_t *pData) {
  NXPLOG_EXTNS_D(NXPLOG_ITEM_NXP_GEN_EXTN, "%s Enter", __func__);
