...
#define FW_MOBILE_ROM_VERSION_CTN820 0x01
#define FW_MOBILE_ROM_VERSION_SN400A 0x01
#define FW_MOBILE_ROM_VERSION_SN400B 0x02
...
#define FW_MOBILE_MAJOR_NUMBER_CTN820 0x01
#define FW_MOBILE_MAJOR_NUMBER_SN400A 0x010
#define FW_MOBILE_MAJOR_NUMBER_SN400B 0x01
  ...
  {                                                   \
    ...
    switch (chipType) {                               \
      ...
      case sn300u:                                    \
        ...
        break;                                        \
      case ctn820:                                    \
        nfcFL.chipType = ctn820;                      \
        nfcFL.nfcNxpEse = false;                      \
        CONFIGURE_FEATURELIST_NFCC_WITH_ESE(chipType) \
        break;                                        \
      case sn400u:                                    \
        nfcFL.chipType = sn400u;                      \
        nfcFL.nfcNxpEse = true;                       \
        CONFIGURE_FEATURELIST_NFCC_WITH_ESE(chipType) \
        break;                                        \
      default:                                        \
  ...
  {                                                     \
    switch (chipType) {                                 \
      ...
      case sn300u:                                      \
        ...
        break;                                          \
      case sn400u:                                      \
        CONFIGURE_FEATURELIST_NFCC(sn400u)              \
        nfcFL.nfccFL._NFCC_SPI_FW_DOWNLOAD_SYNC = true; \
        break;                                          \
      case ctn820:                                      \
        CONFIGURE_FEATURELIST_NFCC(ctn820)              \
        nfcFL.nfccFL._NFCC_SPI_FW_DOWNLOAD_SYNC = true; \
        break;                                          \
      default:                                          \
        break;                                          \
  ...
  {                                                                    \
    ...
    switch (chipType) {                                                \
      ...
      case ctn820:                                                     \
        ...
        nfcFL.nfccFL._NFCC_I2C_READ_WRITE_IMPROVEMENT = true;          \
        nfcFL.nfccFL._NFCC_FORCE_FW_DOWNLOAD = true;                   \
        nfcFL._FW_MOBILE_MAJOR_NUMBER = FW_MOBILE_MAJOR_NUMBER_CTN820; \
        STRCPY_FW("libctn820_fw")                                      \
        STRCPY_FW_BIN("ctn820")                                        \
        break;                                                         \
      case sn400u:                                                     \
        nfcFL.nfccFL._NFCC_DWNLD_MODE = NFCC_DWNLD_WITH_NCI_CMD;       \
        nfcFL.nfccFL._NFCC_I2C_READ_WRITE_IMPROVEMENT = true;          \
        nfcFL.nfccFL._NFCC_MIFARE_TIANJIN = false;                     \
        nfcFL.nfccFL._NFCC_FORCE_FW_DOWNLOAD = true;                   \
        nfcFL._FW_MOBILE_MAJOR_NUMBER = FW_MOBILE_MAJOR_NUMBER_SN400A; \
        STRCPY_FW("libsn400u_fw")                                      \
        STRCPY_FW_BIN("sn400u")                                        \
        break;                                                         \
      default:                                                         \
        nfcFL.nfccFL._NFCC_FORCE_FW_DOWNLOAD = true;                   \
        break;                                                         \
